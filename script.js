...
async function handlePanelSubmit(e) {
  ...
  try {
    const res = await fetch("https://backend-mikazu.vercel.app/create", {
      method: "POST",
...
async function handleAdminSubmit(e) {
  ...
  try {
    const res = await fetch("https://backend-mikazu.vercel.app/create-admin", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
async function fetchServers() {
  ...
  try {
    const res = await fetch("https://backend-mikazu.vercel.app/servers");
...
async function deleteServer(id) {
  ...
  try {
    const res = await fetch(`https://backend-mikazu.vercel.app/server/${id}`, {
      method: "DELETE"
    });
...
async function fetchAdmins() {
  ...
  try {
    const res = await fetch("https://backend-mikazu.vercel.app/admins");
...
async function deleteAdmin(id) {
  ...
  try {
    const res = await fetch(`https://backend-mikazu.vercel.app/admin/${id}`, {
      method: "DELETE"
    });
